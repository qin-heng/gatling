...
# echo "JAVA=$JAVA" "OLDDIR=$OLDDIR" "BIN_DIR=$BIN_DIR" "DEFAULT_GATLING_HOME=$DEFAULT_GATLING_HOME" "GATLING_HOME=$GATLING_HOME" "JAVA_OPTS=$JAVA_OPTS" "CLASSPATH=$CLASSPATH"
